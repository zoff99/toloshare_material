...
cd x265_git/
  ...
  if [ "$1""x" == "raspix" ]; then
    ...
    # /usr/bin/ld: /home/runner/work/toloshare_material/toloshare_material/inst//lib/libx265.a(cpu-a.asm.o): relocation R_X86_64_PC32 against symbol `x265_intel_cpu_indicator_init' can not be used when making a shared object; recompile with -fPIC
