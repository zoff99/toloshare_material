...
dependencies {
    ...
    implementation("io.ktor:ktor-client-apache5:3.4.1")
    ...
    application {
        ...
        nativeDistributions {
            ...
            macOS {
                ...
                bundleID = "com.zoffcc.applications.tolosharematerial"
...
val desktopFile = project.file("resources/toloshare_material.desktop")
...
tasks {
    ...
    val copyAppimageIconfile by registering(Exec::class) {
        ...
        println("iconFile_dst=" + "${linuxAppDir}/toloshare_material.png")
        @Suppress("RemoveSingleExpressionStringTemplate", "RemoveCurlyBracesFromTemplate")
        println("appName=" + "${appName}")
        commandLine("cp", "-v", linuxIconFile, "${linuxAppDir}/toloshare_material.png")
    }

    val setAppimageRunfile by registering(Exec::class) {
        workingDir = linuxAppDir
        commandLine("ln", "-sf", "toloshare_material/bin/toloshare_material", "AppRun")
    }
